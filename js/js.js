...
const rulesArr = [
    ...
    {
        h4: "Оскорбления",
        p: "при оскорблении других участников<br>в первый раз, Вам выдаётся преду-<br>преждение, в случае повторных ка-<br>зусов &mdash; мут на 3 часа. В случае если<br>оскорбления перетекают в травлю, <br>Вам выдаётся бан навсегда.",
    },
    {
        h4: "Контент 18+",
        p:
            "контент с материалами 18+ разрешён<br>при условии, что там имеется цензура<br>и вы предупредили о своём намерении.<br>материалы с частично обнажёнными ча-<br>стями тела(кроме половых органов)не<br>попадают под действие данного правила.",
    },
    {
        h4: "Ccоры",
        p:
            "желательно решать недопонимания в лс,<br>но если же такого не происходит и это про-<br>сто перепалка, то так и быть.ситуация, пе-<br>рерастающая в серьёзную ссору, которая<br>портит атмосферу чата, карается предупре-<br>ждением, потом мутом минимум на 3 часа.<br>если дело доходит до травли &mdash; бан навсегда.",
    },
    { h4: "Неактив", p: "неактив более 5 дней карается<br>баном. нью, которые в чате не более<br>5 дней, данное правило не касается." },
    { h4: "Политика", p: "обсуждение политики строго-настрого<br>запрещено. за нарушение выдаётся предупре-<br>ждение при повторном нарушении &mdash; бан." },
